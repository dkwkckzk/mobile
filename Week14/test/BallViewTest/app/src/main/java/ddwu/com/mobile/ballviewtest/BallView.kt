...
class BallView : View {
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        if (isStart) {
            ...
            ballX = width?.div(2)?.toFloat() ?: 100f // 맨처음 위치 0 이하 안되게
            ballY = height?.div(2)?.toFloat() ?: 100f // 맨처음 위치 0 이하 안되게
            isStart = false
        }
